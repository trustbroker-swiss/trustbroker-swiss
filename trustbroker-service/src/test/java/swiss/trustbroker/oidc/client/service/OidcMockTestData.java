...
class OidcMockTestData {

	static final String CLIENT_ID = "client1";

	static final String CLIENT_SECRET = "secret1";

	static final String CP_ISSUER_ID = "http://localhost:5050";

	static final String CP_HOME_NAME = "cpHome1";

	static final String REALM = "realm1";

	static final String CODE = "code123";

	static final String REDIRECT_URI = "http://localhost:8080/response";
	...
	static final String GIVEN_NAME = "User1GivenName";

	static final String CLAIM_FAMILY_NAME = "family_name";

	static final String FAMILY_NAME = "User1FamilyName";

	static final int USERINFO_ATTRIBUTES = 4;

	static final int BUSINESS_ATTRIBUTES = 3;

	static final int TECHNICAL_ATTRIBUTES = 10;

	static final int TOKEN_ATTRIBUTES = BUSINESS_ATTRIBUTES + TECHNICAL_ATTRIBUTES;

	// trustbroker-oidcmock URL and content
	static final String METADATA_URL = "http://localhost:5050/.well-known/openid-configuration";
	...
	static final String JWKS_ENDPOINT = "http://localhost:5050/oauth2/jwks";

	static final String USERINFO_ENDPOINT = "http://localhost:5050/userinfo";

	static final String AUTHORIZE_ENDPOINT = "http://localhost:5050/oauth2/authorize";

	static final String TOKEN_ENDPOINT = "http://localhost:5050/oauth2/token";
	...
	static final String USERINFO_RESPONSE =
			"""
			{
				"sub": "User1",
	...
	static final String ID_TOKEN = "eyJraWQiOiIwYWZjY2U4ZC1mMGFlLTRlZjgtYmNiNS1mN2E3NDQ2OGYxMWYiLCJhbGciOiJSUzI1NiJ9"
	...
	static final String ACCESS_TOKEN = "eyJraWQiOiJiNjc0ZmQyNC1mYTkyLTRiOTUtYTg5Ni1kMWY4YWI1MGM3MDkiLCJhbGciOiJSUzI1NiJ9"
	...
	static final String SUBJECT = "User1";

	static final String JWT_ID = "797fca08-7817-477e-9a98-55f595def843";

	static final String NONCE = "a46239c90c854b42ae80460d1fa7cd12";

	static final String SP_SESSION_ID = "S2-575b96d5f8f646ccbc8bc8d4a0c69fb3-79a58a9fe5f94379-35e14842e4644a5c967712d8";

	static final String SESSION_ID = "cHR9LzHAA5P7rzyAB1siavOQ_XW_KT-z2l2vKB5tO7w";

	static final int ID_TOKEN_CLAIMS = 13;

	static final ClientAuthenticationMethod[] CLIENT_AUTHENTICATION_METHODS = {
	...
	static final String KEY_ID = "0afcce8d-f0ae-4ef8-bcb5-f7a74468f11f";

	static OpenIdProviderConfiguration givenConfiguration() {
	...
	static OidcClient givenClient() {
		...
		return OidcClient.builder()
						 ...
						 .clientSecret(OidcClientSecretResolver.CLIENT_SECRET_PLAIN + CLIENT_SECRET)
	...
	static OidcClient givenClientWithSecret(String secret) {
		return OidcClient.builder()
						 .id(CLIENT_ID)
						 .clientSecret(secret)
						 .build();
	...
	static ClaimsParty givenCpWithOidcClient(OidcClient client) {
	...
	static StateData givenStateData() {
	...
	static Optional<JWK> givenJwk(String kid) {
