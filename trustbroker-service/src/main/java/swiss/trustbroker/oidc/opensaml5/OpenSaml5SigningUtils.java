 ...
 */
@SuppressWarnings("java:S1213") // opensaml5: ignore code formatting and complexity issues in copied code
final class OpenSaml5SigningUtils {

	static String serialize(XMLObject object) {
		try {
			Marshaller marshaller = XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(object);
			Element element = marshaller.marshall(object);
			return SerializeSupport.nodeToString(element); // opensaml5: different package
		}
	...
	private static SignatureSigningParameters resolveSigningParameters(
		...
		CriteriaSet criteria = new CriteriaSet(); // opensaml5: different package
