...
public interface AccessRequestService {
	...
	boolean requireAccessRequest(RelyingPartyConfig relyingPartyConfig, SessionState stateData);
	...
	AccessRequestResult performFallbackAccessRequestIfRequired(AccessRequestHttpData httpData,
			RelyingPartyConfig relyingPartyConfig, SessionState stateData);
