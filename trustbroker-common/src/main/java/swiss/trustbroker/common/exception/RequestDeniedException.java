...
public class RequestDeniedException extends TrustBrokerException {
	...
	public RequestDeniedException(ErrorCode errorCode, String internalMessage, Throwable exception) {
		super("Access denied", defaultErrorCode(errorCode), internalMessage, exception);
	}
